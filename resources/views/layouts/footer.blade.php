        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2 space-y-6">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 font-poppins">MieKasir</h3>
                        <p class="text-sm text-primary-600 font-medium">Sistem Kasir Modern</p>
                    </div>
                </div>
            ...
            <!-- Quick Links -->
            <div class="space-y-4">
                <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wider">Tautan Cepat</h4>
                <ul class="space-y-3">
                    <li>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-gray-500 text-sm">
                    &copy; {{ date('Y') }} MieKasir. Semua hak cipta dilindungi.
                </p>
